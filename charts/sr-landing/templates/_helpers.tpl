...
{{- else if kindIs "string" $v }}
  value: {{ include "landing.tpl" (dict "value" $v "context" $context) | squote }}
{{- else }}
  valueFrom: {{- include "landing.tpl" (dict "value" $v "context" $context) | nindent 4}}
{{- end }}
{{- end }}
{{- end -}}

{{- define "landing.envVars" -}}
{{- $envVars := merge (deepCopy .Values.envVars) (deepCopy .Values.envVarsFrom) -}}
{{- include "landing.baseEnvVars" (dict "envVars" $envVars "context" $) }}
{{- end -}}
